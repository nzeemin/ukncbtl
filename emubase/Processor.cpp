...
{
    //  R0     (R0)    (R2)+  @(R2)+   -(R1)  @-(R1)   Addr  @Tab(R0)  (PC)+
    { 0x0008, 0x0018, 0x0018, 0x0022, 0x0018, 0x0022, 0x0022, 0x002B, 0x0018 }, // R0
    { 0x0018, 0x0022, 0x0022, 0x0031, 0x0025, 0x0031, 0x0031, 0x003D, 0x0025 }, // (R0)
    { 0x0018, 0x0022, 0x0022, 0x0031, 0x0025, 0x0031, 0x0031, 0x003D, 0x0025 }, // (R2)+
    { 0x0022, 0x002B, 0x002B, 0x003B, 0x0031, 0x003D, 0x003D, 0x0047, 0x0035 }, // @(R2)+
    { 0x0018, 0x0022, 0x0022, 0x0031, 0x0025, 0x0031, 0x0031, 0x003D, 0x0025 }, // -(R1)
    { 0x0022, 0x002B, 0x002B, 0x003B, 0x0031, 0x003D, 0x003D, 0x0047, 0x0035 }, // @-(R1)
    { 0x0022, 0x0031, 0x0031, 0x003B, 0x0031, 0x003B, 0x003B, 0x0045, 0x0031 }, // Addr
    { 0x002B, 0x003B, 0x003B, 0x0045, 0x003B, 0x0045, 0x0045, 0x004F, 0x003D }, // @Tab(R0)
    { 0x0018, 0x0022, 0x0022, 0x002B, 0x0022, 0x002B, 0x0031, 0x003B, 0x0025 }  // (PC)+
};

uint16_t CMPB_TIMING[9][9] =
{
    //  R0     (R0)    (R2)+  @(R2)+   -(R1)  @-(R1)   Addr  @Tab(R0)  (PC)+
    { 0x0008, 0x0018, 0x0018, 0x0022, 0x0018, 0x0022, 0x0022, 0x002B, 0x0026 }, // R0
    { 0x0018, 0x0022, 0x0022, 0x0031, 0x0025, 0x0031, 0x0031, 0x003D, 0x0035 }, // (R0)
    { 0x0018, 0x0022, 0x0022, 0x0031, 0x0025, 0x0031, 0x0031, 0x003D, 0x0035 }, // (R2)+
    { 0x0022, 0x002B, 0x002B, 0x003B, 0x0031, 0x003D, 0x003D, 0x0047, 0x0041 }, // @(R2)+
    { 0x0018, 0x0022, 0x0022, 0x0031, 0x0025, 0x0031, 0x0031, 0x003D, 0x0035 }, // -(R1)
    { 0x0022, 0x002B, 0x002B, 0x003B, 0x0031, 0x003D, 0x003D, 0x0045, 0x0041 }, // @-(R1)
    { 0x0022, 0x0031, 0x0031, 0x003B, 0x0031, 0x003B, 0x003B, 0x0045, 0x003F }, // Addr
    { 0x002B, 0x003B, 0x003B, 0x0045, 0x003B, 0x0045, 0x0045, 0x004F, 0x0049 }, // @Tab(R0)
...
void CProcessor::ExecuteCMP ()
{
    ...
    uint8_t idxsrc = (m_methsrc == 2 && m_regsrc == 7) ? 8 : m_methsrc;
    uint8_t idxdest = (m_methdest == 2 && m_regdest == 7) ? 8 : m_methdest;
    m_internalTick += CMP_TIMING[idxsrc][idxdest];
}
...
void CProcessor::ExecuteCMPB ()
{
    ...
    uint8_t idxsrc = (m_methsrc == 2 && m_regsrc == 7) ? 8 : m_methsrc;
    uint8_t idxdest = (m_methdest == 2 && m_regdest == 7) ? 8 : m_methdest;
    m_internalTick += CMPB_TIMING[idxsrc][idxdest];
}
